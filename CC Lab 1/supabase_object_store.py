...
SUPABASE_URL = "https://zwmodvzxnxkulonqpqtv.supabase.co" 
SUPABASE_KEY = "sb_secret_S4pITowf0hHArTW323aV-g_O8xQ5RIl" 
supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "PES2UG23CS044.png"  # Replace with the local image path
image_name = "PES2UG23CS044.png"  # Desired name for the uploaded file
"""
